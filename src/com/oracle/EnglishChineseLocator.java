...
public class EnglishChineseLocator extends org.apache.axis.client.Service implements com.oracle.EnglishChinese {
 ...
 */
    ...
    public com.oracle.EnglishChineseSoap_PortType getEnglishChineseSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.oracle.EnglishChineseSoap_PortType getEnglishChineseSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.oracle.EnglishChineseSoap12Stub _stub = new com.oracle.EnglishChineseSoap12Stub(portAddress, this);
    ...
    public com.oracle.EnglishChineseSoap_PortType getEnglishChineseSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.oracle.EnglishChineseSoap_PortType getEnglishChineseSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.oracle.EnglishChineseSoap_BindingStub _stub = new com.oracle.EnglishChineseSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.oracle.EnglishChineseSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.oracle.EnglishChineseSoap12Stub _stub = new com.oracle.EnglishChineseSoap12Stub(new java.net.URL(EnglishChineseSoap12_address), this);
                _stub.setPortName(getEnglishChineseSoap12WSDDServiceName());
                return _stub;
            }
            if (com.oracle.EnglishChineseSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.oracle.EnglishChineseSoap_BindingStub _stub = new com.oracle.EnglishChineseSoap_BindingStub(new java.net.URL(EnglishChineseSoap_address), this);
                _stub.setPortName(getEnglishChineseSoapWSDDServiceName());
                return _stub;
            }
        }
