...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.oracle.HelloWorldService {
    ...
    public com.oracle.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.oracle.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.oracle.HelloWorldSoapBindingStub _stub = new com.oracle.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.oracle.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.oracle.HelloWorldSoapBindingStub _stub = new com.oracle.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
